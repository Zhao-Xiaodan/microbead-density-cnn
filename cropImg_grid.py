...
def main():
    ...
    parser = argparse.ArgumentParser(description='Crop images into a grid pattern')
    parser.add_argument('--input', type=str, default="original_images",
    ...
    parser.add_argument('--crop_size', type=int, default=512,
                        help='Size of each crop in pixels (width and height)')
    parser.add_argument('--visualize', action='store_true',
                        help='Generate visualization images of the grid')
    parser.add_argument('--no-visualize', dest='visualize', action='store_false',
                        help='Do not generate visualization images')
    parser.set_defaults(visualize=True)

    args = parser.parse_args()

    # Run the crop function with parsed arguments
    crop_center_grid(args.input, args.output, args.grid_size, args.crop_size, args.visualize)
